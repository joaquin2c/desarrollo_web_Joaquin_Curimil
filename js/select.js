...
const updateComunas = () => {
  ...
  if (region_comuna["regiones"][selectedregion-1]) {
      region_comuna["regiones"][selectedregion-1]["comunas"].forEach(comuna => {
          let option = document.createElement("option");
...
document.getElementById("select-contact1").addEventListener("change", updateContacto1);
document.getElementById("select-contact2").addEventListener("change", updateContacto2);
document.getElementById("select-contact3").addEventListener("change", updateContacto3);
document.getElementById("select-contact4").addEventListener("change", updateContacto4);
document.getElementById("select-contact5").addEventListener("change", updateContacto5);
document.getElementById("add-contact-btn").addEventListener("click", addNewContact);
document.getElementById("add-foto-btn").addEventListener("click", addNewFoto);
document.getElementById("submit-btn").addEventListener("click", validateForm);
document.getElementById("volver").addEventListener("click", goToIndex);
